            ...
            {!loading && myAcceptedRequests.map(post => (
                ...
                >
                  <div className="flex items-start justify-between border-b-2 border-on-surface pb-4 mb-4">
                    ...
                    <div className="text-right bg-primary-container border-2 border-on-surface shadow-[2px_2px_0px_0px_#141414] px-3 py-1">
                  ...
                  <div className="flex gap-3">
                    <button 
                      ...
                      className="flex-grow py-3 bg-primary-container hover:bg-primary-fixed-dim text-on-surface border-2 border-on-surface shadow-[3px_3px_0px_0px_#141414] font-bold uppercase text-xs active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all"
                    >
